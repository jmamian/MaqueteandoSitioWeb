document.addEventListener("DOMContentLoaded", (event) =>{
    ...
    //Función mostrar u ocultar menú
    ...
    //Al dar clic al botón del menú mostrar el menú de navegación responsive
    mobile_btn.addEventListener("click", showHiddenMenu);

    //Al redimensionar la pantalla ocultar el menu si es necesario
    window.addEventListener("resize", () => {
        let window_width = parseIInt(document.body.clientWidth);
